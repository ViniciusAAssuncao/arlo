...
use crate::services::season::conflict::rest_gap_conflict_detector::RestGapConflict;
...
pub fn resolve_rest_gap_conflicts(
    calendar: &CalendarSystem,
    season_start_date: &CalendarDate,
    conflicts: &[RestGapConflict],
    ...
    for conflict in conflicts {
        conflicting_fixture_ids.insert(conflict.conflicting_fixture_id);
    }
    ...
    for fixture_id in sorted_fixture_ids {
        ...
        let record = PostponementRecord::new(
            ...
            fixture.scheduled_date(),
            new_date,
            PostponementReason::InsufficientRestGap,
        );
