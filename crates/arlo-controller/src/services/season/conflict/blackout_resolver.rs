...
use crate::services::season::conflict::blackout_conflict_detector::BlackoutConflict;
...
pub fn resolve_blackout_conflicts(
    ...
    for conflict in conflicts {
        conflicting_fixture_ids.insert(conflict.fixture_id);
    }
    ...
    for fixture_id in sorted_fixture_ids {
        ...
        let record = PostponementRecord::new(
            ...
            fixture.scheduled_date(),
            new_date,
            PostponementReason::CollectiveAgreementBlackout,
        );
