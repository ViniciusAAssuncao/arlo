...
impl Default for RecoveryTuningProfile {
    fn default() -> Self {
        Self {
            ...
            energy_natural_fitness_weight: 0.30,
            ...
            anaerobic_natural_fitness_weight: 0.20,

            impulse_base_daily_reversion_rate: 0.30,
            impulse_determination_weight: 0.20,
            ...
            conditioning_daily_loss_injured: 0.040,
            conditioning_recovery_multiplier_min: 0.70,
            conditioning_recovery_multiplier_max: 1.20,

            injury_grade_1_base_days: 7.0,
            injury_grade_2_base_days: 28.0,
            injury_grade_3_base_days: 90.0,

            region_multiplier_head: 1.00,
            region_multiplier_neck: 1.10,
            region_multiplier_shoulder: 1.05,
            region_multiplier_arm: 0.85,
            region_multiplier_hand: 0.80,
            region_multiplier_trunk: 0.95,
            region_multiplier_hip: 1.25,
            region_multiplier_groin: 1.20,
            region_multiplier_thigh: 1.00,
            region_multiplier_knee: 1.40,
            region_multiplier_calf: 1.05,
            region_multiplier_ankle: 1.05,
            region_multiplier_foot: 1.15,

            observation_duration_fraction: 0.30,
            observation_min_days: 3,
            observation_max_days: 30,

            relapse_base_daily_probability: 0.05,
            relapse_conditioning_mitigation_factor: 0.60,
            relapse_natural_fitness_weight: 0.25,
            relapse_grade_1_multiplier: 0.75,
            relapse_grade_2_multiplier: 1.15,
            relapse_grade_3_multiplier: 1.60,
        }
    }
}
...
impl RecoveryTuningProfile {
    ...
    pub fn calculate_observation_days(&self, injury_recovery_days: u32) -> u32 {
        let calculated = (injury_recovery_days as f64 * self.observation_duration_fraction).round() as u32;
