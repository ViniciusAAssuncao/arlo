...
pub struct ChainAggregationResult {
    ...
    pub fouls: Vec<crate::officiating::foul::FoulResolution>,
    pub injuries: Vec<crate::injury::outcome::InjuryIncidentResolution>,
    pub receiver_id: Option<Uuid>,
    pub distribution_flight: Vec<DistributionFlightInfo>,
    pub first_decision: Option<ArtrineDecisionKind>,
}

pub fn orchestrate_chain<'a, R: Rng + ?Sized>(
    state: &mut MatchState,
    static_ctx: &DownStaticContext<'a>,
    call_context: &CallToActionContext,
    pass_phase: &PassPhaseResult<'a>,
    initial_carrier: &'a Player,
    rng: &mut R,
