...
pub fn calculate_pass_speed_with_state(
    player: &Player,
...
pub fn calculate_pass_speed(
    ...
    calculate_pass_speed_with_state(player, attribute_keys, &PhysicalState::initial())
}

pub fn calculate_cross_speed_with_state(
    player: &Player,
    attribute_keys: &HashMap<Uuid, AttributeKey>,
    state: &PhysicalState,
) -> Speed {
...
pub fn calculate_cross_speed(
    ...
    calculate_cross_speed_with_state(player, attribute_keys, &PhysicalState::initial())
}

pub fn calculate_shot_speed_with_state(
    player: &Player,
    attribute_keys: &HashMap<Uuid, AttributeKey>,
    state: &PhysicalState,
) -> Speed {
...
pub fn calculate_shot_speed(
    ...
    calculate_shot_speed_with_state(player, attribute_keys, &PhysicalState::initial())
}
