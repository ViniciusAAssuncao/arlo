...
pub fn build_detailed_play_outcome(
    ...
    DetailedPlayOutcome {
        ...
        reception_x_mirim: pass_phase.reception_x_mirim,
        reception_y_mirim: pass_phase.reception_y_mirim,
        ...
        last_valid_x_mirim: execution_outcome.end_x_mirim,
        last_valid_y_mirim: execution_outcome.end_y_mirim,
