...
use crate::team_strength::channel_power::TeamMatchPower;
...
pub fn calculate_team_match_power(state: &MatchState, team_id: Uuid) -> TeamMatchPower {
    ...
    let offensive_power = (total_off_ca / 70.0) + off_tactical_bonus;
    let defensive_power = (total_def_ca / 70.0) + def_tactical_bonus;
    let control_power = (total_ctrl_ca / 70.0) + ctrl_tactical_bonus;
